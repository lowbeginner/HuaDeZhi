...
android {
    namespace = "cn.student.expensetracker"
    compileSdk = 35
    defaultConfig {
        applicationId = "cn.student.expensetracker"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
    ...
    signingConfigs {
        if (releaseKeyFile.exists()) create("personalRelease") {
    ...
    buildTypes {
        release {
            ...
            if (releaseKeyFile.exists()) signingConfig = signingConfigs.getByName("personalRelease")
        }
    }
    compileOptions {
